...
- Side Note: Don't read the commit of this repo coz they don't make sense I added them just for fun/easter eggs
...
1. Write a program to print the sum and product of the digits of an integer.
...
<!-- END OF 1ST SEMESTER SYLLABUS-->
<br/>
<!-- START OF 2ND SEMESTER SYLLABUS-->
